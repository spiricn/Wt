...
SliderView::SliderView(View* parent, EventManager* eventManager, AGameInput* input) : mValue(30.0f), mBarWidth(25.0f), mBaseColor(127.0/255.0, 127.0/255.0, 127.0/255.0),
