...
/* Generated from "./shaders\rect_shader.vp" */
static const char* rect_shader_vp = 
	"#version 330\n"
	"\n"
	"in vec4 inPosition;\n"
	"in vec2 inTexCoord;\n"
...
/* Generated from "./shaders\rect_shader.fp" */
static const char* rect_shader_fp = 
	"#version 330\n"
	"\n"
	"in vec2 fsTexCoord;\n"
	"\n"
	...
	"\n"
	"void main(){\n"
	" 	outFragColor = texture(uRectImage, fsTexCoord) + vec4(1, 0, 0, 0);\n"
	"}\n"
; // </rect_shader_fp>
...
const char* getShaderSource(const char* uri){
	if(!gMapInitialized){
		...
		gSourceMap.insert( std::make_pair("rect_shader.vp", rect_shader_vp) );
		...
		gSourceMap.insert( std::make_pair("rect_shader.fp", rect_shader_fp) );
		...
		LOGV("Shader map initialized with 35 shaders");
